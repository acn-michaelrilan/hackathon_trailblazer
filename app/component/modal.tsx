...
//       const body = panelRef.current.querySelector(".modal-body-scroll");
...
//       document.documentElement.classList.add("modal-open"); // lock scroll via CSS
//     } else {
...
//       {/* Panel: fixed size, internal scroll */}
//       <div
//         ref={panelRef}
...
//                         px-6 py-4 border-b border-slate-100 bg-white rounded-t-2xl">
...
//         {/* Body (scrollable) */}
//         <div className="h-[calc(80vh-64px)] overflow-y-auto px-6 py-4 modal-body-scroll">
//           {children}
//         </div>
//       </div>
//     </div>
