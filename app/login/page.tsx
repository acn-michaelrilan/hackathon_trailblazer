          ...
          <div className="relative bg-white rounded-3xl w-full max-w-lg p-8 shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 max-h-60 overflow-y-auto text-sm text-gray-600 leading-relaxed border border-gray-100">
              <h3 className="font-bold text-gray-800 mb-2">
                Terms &amp; Conditions: AI-Guided Adaptive Exercise Planner
              </h3>
              <p className="mb-3 text-xs text-gray-400 italic">
                Last Updated: February 2026
              </p>
              <p className="mb-4">
                <strong>1. Nature of AI Recommendations:</strong> You acknowledge
                that the exercise plans provided are generated by an Artificial
                Intelligence (AI) algorithm. While designed to be adaptive and
                data-driven, these recommendations are for informational
                purposes only and do not constitute professional medical advice
                or physical therapy.
              </p>

              <p className="mb-4">
                <strong>2. Health &amp; Safety Warning:</strong> Always consult
                with a physician before starting any new exercise program. You
                assume all risks associated with physical activity. If you
                experience pain, dizziness, or shortness of breath at any time,
                you must stop the exercise immediately.
              </p>

              <p className="mb-4">
                <strong>3. Adaptive Data Usage:</strong> Our AI improves by
                analyzing your performance data. By using this service, you
                grant us permission to process your workout metrics, heart rate
                data (if provided), and feedback to refine and personalize your
                adaptive plan.
              </p>

              <p className="mb-4">
                <strong>4. Limitation of Liability:</strong> Trailblazers and
                its affiliates shall not be held liable for any injuries, health
                complications, or damages resulting from the use of AI-generated
                workout plans or the misinterpretation of exercise instructions.
              </p>

              <p className="mb-4">
                <strong>5. User Responsibility:</strong> You are responsible for
                ensuring your exercise environment is safe and that you have the
                proper equipment. The AI cannot &quot;see&quot; your surroundings
                or verify your form in real-time unless specifically stated.
              </p>

              <p className="mb-4">
                <strong>6. Privacy &amp; Security:</strong> Your biometric data
                is encrypted. However, you are responsible for maintaining the
                confidentiality of your account credentials to prevent
                unauthorized access to your health profile.
              </p>
